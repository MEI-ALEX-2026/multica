...
This configures the CLI for the local self-hosted server, opens your browser for login, discovers your workspaces, and starts the agent daemon.

For Multica Cloud, use `multica setup cloud`. For custom self-hosted servers, use `multica setup self-host`. See [Self-Hosting](/getting-started/self-hosting) for details.
