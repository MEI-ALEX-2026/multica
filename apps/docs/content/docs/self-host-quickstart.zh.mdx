...
- **前端**：[http://localhost:57891](http://localhost:57891)
- **后端**：[http://localhost:57890](http://localhost:57890)
...
打开 [http://localhost:57891](http://localhost:57891)：
...
```bash
multica setup self-host --server-url http://<你的服务器地址>:57890 --app-url http://<你的服务器地址>:57891
```
...
默认连 `http://localhost:57890`（backend）+ `http://localhost:57891`（frontend）。
