...
| Backend port | `57890` | generated (e.g. `18782`) |
| Frontend port | `57891` | generated (e.g. `13702`) |
...
pnpm install
pnpm dev:web          # Next.js dev server (port 57891)
...
# Backend (Go)
make dev              # Run Go server (port 57890)
