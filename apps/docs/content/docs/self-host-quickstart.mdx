...
- **Frontend**: [http://localhost:57891](http://localhost:57891)
- **Backend**: [http://localhost:57890](http://localhost:57890)
...
Open [http://localhost:57891](http://localhost:57891):
...
```bash
multica setup self-host --server-url http://<your-server-address>:57890 --app-url http://<your-server-address>:57891
```
...
That defaults to `http://localhost:57890` (backend) and `http://localhost:57891` (frontend).
