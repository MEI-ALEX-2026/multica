...
setup_server() {
  ...
  for i in $(seq 1 45); do
    if curl -sf http://localhost:57890/health >/dev/null 2>&1; then
      ready=true
      break
    fi
    sleep 2
...
run_default() {
  ...
  printf "\n"
  printf "     ${CYAN}multica setup${RESET}                # Connect to local self-host (localhost)\n"
  printf "     ${CYAN}multica setup cloud${RESET}          # Connect to Multica Cloud (multica.ai)\n"
  printf "     ${CYAN}multica setup self-host${RESET}       # Connect to a custom self-hosted server\n"
  printf "\n"
...
run_with_server() {
  ...
  printf "${BOLD}${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}\n"
  printf "\n"
  printf "  ${BOLD}Frontend:${RESET}  http://localhost:57891\n"
  printf "  ${BOLD}Backend:${RESET}   http://localhost:57890\n"
